...
def fakeEmail():
  faker = Faker()
  print ('')
  print ('             \033[1;34m[ Tool Random Email ]')
  print ('')
  data_kytu = ['', '_', '.']
  ...
  for fake in range(so_luong):
    ...
    print (" [" + str(n) + "] ➻❥ |Xuân Dương|" + fake_email)
...
def checkhotmail():
  ...
  def run_check_hotmail(hot_mail):
    s = session()
    response = s.get('https://signup.live.com/signup?username='+hot_mail+'&lic=1')
    kq = re.search("isAvailable",response.text)
    if kq == None:
      print (" \033[1;31m➻❥ |\033[1;37mXuân Dương \033[1;31m|Email Live|" + hot_mail)
    else:
      print (" \033[1;32m➻❥ |\033[1;37mXuân Dương \033[1;32m|Email Die|" + hot_mail)
      open(hotmail_die,'a').write(hot_mail + "\n")
  # chỗ này để làm đa luồng quá trình check hotmail
...
def checkyahoo():
  ...
  def run_check_yahoo(yid):
    ...
    if KQ == None:
      print(" \033[1;32m➻❥ |\033[1;37mXuân Dương \033[1;32m|Email Die| " + yid + "@yahoo.com")
      open(yahoo_die,"a").write(yid + "@yahoo.com" + "\n")
    else:
      print(" \033[1;31m➻❥ |\033[1;37mXuân Dương \033[1;31m|Email Live| " + yid + "@yahoo.com")
  with concurrent.futures.ThreadPoolExecutor() as executor:
...
def checkvalid():
  ...
  def run_check_valid(emailfb):
    ...
    'accept-language': 'vi-VN,vi;q=0.9,fr-FR;q=0.8,fr;q=0.7,en-US;q=0.6,en;q=0.5',
    'cookie':'sb=N7cFYD75qjxPpi5bheGd-xBH; datr=O7cFYOGqdMieLY7qGIq5LcPG; _fbp=fb.1.1641390145542.120452399; locale=vi_VN; m_pixel_ratio=1; wd=674x625; fr=0xd02tedzgeHkfJng.AWXiw3JEnRLXYVZHJuURAlRU_bM.BiN0x3.r5.AAA.0.0.BiN_fp.AWXumcyq0Ak'
}
    data = {
        'lsd':'AVqwPiWHIqQ',
        'jazoest':'2994',
    ...
    'accept-language': 'vi-VN,vi;q=0.9,fr-FR;q=0.8,fr;q=0.7,en-US;q=0.6,en;q=0.5',
    'cookie':'sb=N7cFYD75qjxPpi5bheGd-xBH; datr=O7cFYOGqdMieLY7qGIq5LcPG; _fbp=fb.1.1641390145542.120452399; locale=vi_VN; m_pixel_ratio=1; wd=674x625; fr=0xd02tedzgeHkfJng.AWV1_5Y0yEFexdHjPYEwdo_jZFQ.BiN0x3.r5.AAA.0.0.BiN_f4.AWWjT111ZXo; sfiu=AYivpMD5glvpzMMu4rDB9eQMBcL1L-J5YnmUlmCPWgEBtQ3uFPGpkzoNAKyj5lSXWuq3cNGbqLU2FB5LGuowx17UVtRpEmecrzQkjmX_rTLhezyenbKfm6-XC7B143Mtzu7koGNKCBBjwjYtsCWSuIojlxLIGqHAG4h5bRsZhDKBcFFn263izSTgXbOC8--vR4irfk-MHTEfuL0Ssebwm9Li',
}
    ...
    if valid_fb == None:
      ...
      kq_check_code = re.search("Vui lòng kiểm tra mã trong email của bạn. Mã này gồm 6 số.",check_code.text)
      if kq_check_code == None:
        print (" \033[1;32m➻❥ |\033[1;37mXuân Dương \033[1;32m|Có Liên Kết|Code 8|" + emailfb)
        open(valid,"a").write("|code 8|" + emailfb + "\n")
      else:
        print (" \033[1;32m➻❥ |\033[1;37mXuân Dương \033[1;32m|Có Liên Kết|Code 6|" + emailfb)
        open(valid,"a").write("|code 6|" + emailfb + "\n")
    else:
      print (" \033[1;31m➻❥ |\033[1;37mXuân Dương \033[1;31m| Không Liên Kết |" + emailfb)
  with concurrent.futures.ThreadPoolExecutor() as executor:
...
def logo():
  logo = """
        ...
        \033[1;36m░░▀░░ ▀▀▀▀ ▀▀▀▀ ▀▀▀   \033[1;34m▀▀▀ ▀░░▀ ▀▀▀ ▀▀▀ ▀░░▀   \033[1;35m▀░░░▀ ▀░░▀ ▀▀▀ ▀▀▀
                  \033[0;33m➻❥ Copyright By : BÙI XUÂN DƯƠNG
                  \033[1;34m➻❥ DONATE MOMO : 0365264344
                  \033[1;32m➻❥ Facebook : https://facebook.com/duong.dep.trai.nek
"""
